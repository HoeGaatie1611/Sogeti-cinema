...
import {searchByTitle, searchForMovies} from "../Controllers/API";

// import {getAge, getAlexaData, getHighestMoz, getIP, getRanking, extractWebsites} from '../../components/Functions/Functions.jsx'
...
class Hero extends React.Component {
	...
	componentDidMount() {
		if (this.props.movie === "sonic") {
			searchByTitle(this.props.movie, "short")
				.then(r => {
					console.log(r);
					this.setState({
						loaded: true,
